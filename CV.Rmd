...
## $\text{\underline{Professional Development Workshops}}$
```{=latex}
\setlength{\parindent}{-0.2in}
\setlength{\leftskip}{0.2in}
\setlength{\parskip}{8pt}
...
## $\text{\underline{At Regional or National Conferences}}$
```{=latex}
\setlength{\parindent}{-0.2in}
\setlength{\leftskip}{0.2in}
\setlength{\parskip}{8pt}
\textbf{Wenz, C.} \& Warrnader, K. (2018). The College Writing Motivation Scale: a tool for measuring motivation in Writing Center contexts. Paper presented at the Northeast Writing Center Association Conference, Worcester, MA.

\textbf{Wenz, C.} (2017). Disciplinary literacy and journalism: literacy instruction in a post truth world. Paper presented at the Literacy Research Association Annual Conference, Tampa, FL.

Kowitt, J., \textbf{Wenz, C.} \& Friedlander, L. (2017). Enhancing Observational Skills: Inclusive Museum Programming for Visitors with Autism Spectrum Disorder. Paper presented at the Tenth International Conference on the Inclusive Museum, Manchester, UK.

Gabriel, R., \textbf{Wenz, C.} (2015) Opportunities to Develop Literacy Scale. Paper presented at the Literacy Research Association Annual Conference, Carlsbad, CA.

\textbf{Wenz, C.}, \& Gabriel, R. (2015) An integrative review and pilot survey of disciplinary literacy instruction in secondary settings. Poster presented at the Annual Meeting of the American Educational Research Association, Chicago, IL
```
