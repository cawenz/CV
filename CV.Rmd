...
Gabriel, R. and textbf{Wenz, C.} (2016). \emph{The challenge of adolescent literacy: text types and tasks of secondary content areas.} Research presented at the Association of Literacy Educators and Researchers, Myrtle Beach, SC. 
...
\underline{Phone}: (617) 721-0995 \\
\underline{Email}: rachael.gabriel@uconn.edu \\[1mm]
Dr. Gabriel was my doctoral advisor and I served as her research assistant for four years.
\\
```
```{=latex}
...
University of Connecticut \\
\underline{Phone}: (860) 486-9728 \\
\underline{Email}: tom.deans@uconn.edu \\[1mm]
Dr. Deans was the Director of the University Writing Center when I worked there as a Graduate Writing Tutor.
\\
```
```{=latex}
\textbf{Tom Hays, PhD} \\
...
Franklin Academy \\
\underline{Phone}: (860) 873-2700 \\
\underline{Email}: tom@fa-ct.org \\[1mm]
Dr. Hays was the Educational Director at Franklin Academy when I served as Humanities Instructor and Residential Dean.
\\
```
