...
experience <- tribble(~title, ~employer, ~startYear,~endYear, ~where, ~why,
    ...
    2018, 2020, "Putney, VT", 
        # Third Bullet
        " Conducted research on universal design for learning, neurodiversity and instruction for students with learning differences.", 
    #
    "Research Scientist", "Landmark College Institute for Research and Training (LCIRT)", 
    2018, 2020, "Putney, VT", 
    # Fourth Bullet
    "Served the college as member of the Center for Neurodiversity Steering Committee and Pedagogy Committee.", 
    ...
    2014, 2018, "Storrs, CT", 
        # First Bullet
        "Provided research support for projects related to school-university partnerships, literacy instruction in the content areas and interventions for students with reading and writing difficulties.",
        #
    "Research and Teaching Assistant", "Department of Curriculum & Instruction --- University of Connecticut", 
    2014, 2018, "Storrs, CT", 
        # Second Bullet
...
sciences.",
    ...
    2012, 2015, "Storrs, CT", 
    # First Bullet
    "Provided individualized academic, executive function and social coaching for neurodivergent college students.",
    #
    "Strategy Instructor", "Center for Students with Disabilities---University of Connecticut",
    2012, 2015, "Storrs, CT", 
    # Second Bullet
    "Designed and delivered workshops in relationships and sexuality for students with autism.",
    #
    # Franklin 1
    "Residential Dean and Humanities Instructor", "Franklin Academy", 
    2007, 2012, "East Haddam, CT", 
    # First Bullet
    "Founded and facilitated a residential, post-secondary transition program for neurodivergent students.",
    #
    "Residential Dean and Humanities Instructor", "Franklin Academy", 
    2007, 2012, "East Haddam, CT", 
    # Second Bullet
    "Managed a 15 member residential duty team responsbile for the safety and wellbeing of 80+ neurodivergent students.",
    #
    "Residential Dean and Humanities Instructor", "Franklin Academy", 
    2007, 2012, "East Haddam, CT", 
    # Third Bullet
